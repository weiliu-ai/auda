...
if __name__ == '__main__':
    ...
    #root_dir = '/media/qq/data/datasets/segmentation/nuscenes/v1.0-mini'
    #out_dir = '/media/qq/data/datasets/segmentation/nuscenes_preprocess_xmuda/v1.0-mini'
    

    #for v1.0-trainva  dataset
    root_dir = '/media/qq/data/datasets/segmentation/nuscenes/v1.0-trainval'
    out_dir = '/media/qq/data/datasets/segmentation/nuscenes_preprocess_auda'
