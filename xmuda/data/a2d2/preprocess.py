...
if __name__ == '__main__':
    #/media/weiliu/New Volume1/data/datasets/3D_segmentation
    #root_dir = '/datasets_master/a2d2'
    #out_dir = '/media/weiliu/New Volume1/data/datasets/3D_segmentation/a2d2_preprocess'
    ## TODO 
    root_dir = '/media/weiliu/New Volume1/data/datasets/3D_segmentation/a2d2'
    out_dir = '/media/weiliu/New Volume1/data/datasets/3D_segmentation/a2d2_preprocess' 
