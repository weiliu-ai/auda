...
if __name__ == '__main__':
    #TODO
    root_dir = '/media/weiliu/New Volume1/data/datasets/3D_segmentation/semantic_kitti'
    out_dir = '/media/weiliu/New Volume1/data/datasets/3D_segmentation/semantic_kitti_preprocess'
