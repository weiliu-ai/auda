    ...
    with torch.no_grad():
        for iteration, data_batch in enumerate(dataloader):
            ...
            for batch_ind in range(len(seg_label)):  # the index of the sample in the batch
                ...
                print('orig_points_idx:',np.shape(data_batch['orig_points_idx'][batch_ind])[0])
                print('curr_points_idx.sum():', curr_points_idx.sum())
